...
import (
	...
	prometheusiov1alpha1 "github.com/myonlyzzy/prometheus-operator/pkg/apis/prometheus.io/v1alpha1"
	versioned "github.com/myonlyzzy/prometheus-operator/pkg/client/clientset/versioned"
	internalinterfaces "github.com/myonlyzzy/prometheus-operator/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/myonlyzzy/prometheus-operator/pkg/client/listers/prometheus.io/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PrometheusV1alpha1().Prometheuses(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PrometheusV1alpha1().Prometheuses(namespace).Watch(options)
			},
		},
		&prometheusiov1alpha1.Prometheus{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *prometheusInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&prometheusiov1alpha1.Prometheus{}, f.defaultInformer)
}
